...
namespace QuestSystem
{
    ...
    {
        [PropertyOrder(1)] [TitleGroup("General Information")] [SerializeField]
        public string title;

        [PropertyOrder(2)] [TitleGroup("General Information")] [TextArea] [SerializeField]
        public string description;

        [PropertyOrder(3)] [TitleGroup("General Information")] [SerializeField]
        public bool completed;

        [PropertyOrder(11)] [TitleGroup("Behaviour")] [SerializeReference]
        public QuestBehaviour questBehaviour;

        [PropertyOrder(21)] [TitleGroup("Completion")] [SerializeReference]
        public List<QuestCompletionBehaviour> completionBehaviours;

        [PropertyOrder(22)] [TitleGroup("Completion")] [SerializeField]
