	...
	public class LTDescr
    {
        ...
        public LTDescr setColor()
        {
            ...
            easeInternal = () => {
                ...
                else if (dt != 0f && _optional.onUpdateColorObject != null) _optional.onUpdateColorObject(toColor, _optional.onUpdateParam);
            };
            return this;
        }
...
//		Debug.Log ("tween:" + this+ " dt:"+dt);
        ...
        public void callOnCompletes()
        {
            ...
            if (type == TweenAction.DELAYED_SOUND) AudioSource.PlayClipAtPoint((AudioClip)_optional.onCompleteParam, to, from.x);
...
//		val = (val * val * val * val - 2f);
        ...
        {
            loopCount = repeat;
            if ((repeat > 1 && loopType == LeanTweenType.once) || (repeat < 0 && loopType == LeanTweenType.once)) loopType = LeanTweenType.clamp;
        ...
        public LTDescr setDirection(float direction)
        {
            ...
            if (this.direction != direction)
            {
                ...
                else
                {
                    ...
                    else if (_optional.spline != null) _optional.spline = new LTSpline(LTUtility.reverse(_optional.spline.pts));
